...
# ACDS 20.1 711 win32 2024.12.14.21:40:00
...
# ----------------------------------------
# If serial_flash is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/serial_flash.v"                                                     
fi
