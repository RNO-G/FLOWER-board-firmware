...
# ACDS 20.1 711 win32 2024.12.14.21:40:48
...
# ----------------------------------------
# If epcqio_block is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/epcqio_block_asmi_parallel_0.v" -work asmi_parallel_0 -cdslib ./cds_libs/asmi_parallel_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/epcqio_block.vhd"                                                                                          
fi
