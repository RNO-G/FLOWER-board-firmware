...
# ACDS 20.1 711 win32 2024.12.14.21:40:24
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/remote_update_remote_update_0.v" -work remote_update_0    -cdslib ./cds_libs/remote_update_0.cds.lib   
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/remote_update.vhd"                                                                                                
fi
