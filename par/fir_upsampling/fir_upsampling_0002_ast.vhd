...
attribute altera_attribute of fir_upsampling_0002_ast:entity is "-name MESSAGE_DISABLE 15400; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 12020; -name MESSAGE_DISABLE 12030; -name MESSAGE_DISABLE 12010; -name MESSAGE_DISABLE 12110; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 13410; -name MESSAGE_DISABLE 10036";
end fir_upsampling_0002_ast;

-- Warnings Suppression On
-- altera message_off 10036

architecture struct of fir_upsampling_0002_ast is
...
real_passthrough : if COMPLEX_CONST = 1 generate
      ...
      component fir_upsampling_0002_rtl_core is
      port (
...
end component fir_upsampling_0002_rtl_core;
  ...
  begin
        hpfircore_core: fir_upsampling_0002_rtl_core
           port map (
